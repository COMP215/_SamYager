...
class LinkedListGraph {
	...
	vector<vector<string> > connections;	//vector of vectors of connections in the mst, to avoid cycles
public:
	...
	void CreateHeap();		//creates a more useful heap of values to use for MST algorithms
	void KruskalMST();		//creates a minimum spanning tree using Kruskal's algorithm
};
